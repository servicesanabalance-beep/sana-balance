  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: 'bg-amber-600 text-white hover:bg-amber-600 hover:text-white focus:bg-amber-600 focus:text-white dark:bg-amber-600 dark:text-white dark:hover:bg-amber-600 dark:hover:text-white dark:focus:bg-amber-600 dark:focus:text-white',
