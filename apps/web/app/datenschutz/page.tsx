        ...
        <div className="prose prose-lg max-w-none space-y-6 text-sana-brown">
          ...
          <section>
            ...
            <p className="font-semibold">
              ...
              9472 Grabs<br />
              Schweiz<br />
              E-Mail: <a href="mailto:kontakt@sanabalance.ch" className="text-[#8B7355] hover:text-[#6B5744] underline">kontakt@sanabalance.ch</a>
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Zur Ausübung dieser Rechte wenden Sie sich bitte an: <a href="mailto:kontakt@sanabalance.ch" className="text-[#8B7355] hover:text-[#6B5744] underline">kontakt@sanabalance.ch</a>
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Wenn Sie Fragen zum Datenschutz haben, schreiben Sie uns bitte eine E-Mail an: <a href="mailto:kontakt@sanabalance.ch" className="text-[#8B7355] hover:text-[#6B5744] underline">kontakt@sanabalance.ch</a>
            </p>
          </section>
