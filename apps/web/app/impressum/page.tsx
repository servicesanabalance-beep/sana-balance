        ...
        <div className="prose prose-lg max-w-none space-y-6 text-sana-brown">
          ...
          <section>
            ...
            <p>
              ...
              <strong>E-Mail:</strong> <a href="mailto:kontakt@sanabalance.ch" className="text-[#8B7355] hover:text-[#6B5744] underline">kontakt@sanabalance.ch</a><br />
              <strong>Web:</strong> sanabalance.ch
            </p>
          </section>
