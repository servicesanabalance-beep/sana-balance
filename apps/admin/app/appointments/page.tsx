          ...
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <Card className="w-full max-w-2xl bg-white dark:bg-gray-800 shadow-2xl">
              <CardHeader className="bg-gradient-to-r from-[#6B5744] to-[#8B7355] text-white">
                <CardTitle className="text-white">Neuer Termin</CardTitle>
              </CardHeader>
              <CardContent className="p-6">
                <form onSubmit={handleCreateAppointment} className="space-y-4">
                  ...
                  <div>
                    ...
                    {availableSlots.length === 0 && formData.date && (
                      <p className="text-sm text-amber-600 mt-1">
                        Keine verfügbaren Zeitslots für dieses Datum. Bitte fügen Sie zuerst Zeitslots in der Verfügbarkeit hinzu.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="flex gap-3 pt-4">
                    <Button type="submit" className="px-6 py-2 bg-[#C9A87C] hover:bg-[#B8976B] text-white">
                      Termin erstellen
                    </Button>
                    <Button
                      type="button"
